...
@section('content')
    <div class="login-right">
        <div class="login-right-wrap">
            <h1>Daftar</h1>
            <p class="account-subtitle">Masukan Detail Akun</p>
            <form action="{{ route('register') }}" method="POST">
                ...
                <div class="form-group mb-0">
                    <button class="btn btn-primary btn-block" type="submit">Registrasi</button>
                </div>
            </form>
            <div class="login-or">
